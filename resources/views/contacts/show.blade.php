<x-app-layout>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="container px-5 mx-auto">
                    ...
                    <div class="flex flex-wrap -m-2">
                        ...
                        @csrf
                        <div class="p-2 w-full">
                        <a hre="#" data-id="{{ $contact->id }}" onclick="deletePost(this)" class="flex mx-auto text-white bg-pink-500 border-0 py-2 px-8 focus:outline-none hover:bg-pink-600 rounded text-lg">削除する</a>
                        </div>
                        </form>
    ...
    function deletePost(e){
        ...
        if(confirm('本当に削除していいですか？')){
            document.getElementById('delere__' + e.dataset.id).submit()
        }
    }
    </script>
</x-app-layout>
